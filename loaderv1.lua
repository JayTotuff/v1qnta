...
local Window = Library:Window({
    ...
    -- Initialize Options and MiscOptions tables with default values
    Options = Options or {}
    MiscOptions = MiscOptions or {}
    
    -- ESP Options defaults
    Options["Box Gradient 1"] = {Color = Color3.fromRGB(255, 255, 255), Transparency = 0}
    Options["Box Gradient 2"] = {Color = Color3.fromRGB(255, 255, 255), Transparency = 0}
    Options["Box Fill 1"] = {Color = Color3.fromRGB(255, 255, 255), Transparency = 0.9}
    Options["Box Fill 2"] = {Color = Color3.fromRGB(0, 0, 0), Transparency = 0.9}
    Options["Healthbar_Low"] = {Color = Color3.fromRGB(255, 0, 0), Transparency = 0}
    Options["Healthbar_Medium"] = {Color = Color3.fromRGB(255, 255, 0), Transparency = 0}
    Options["Healthbar_High"] = {Color = Color3.fromRGB(0, 255, 0), Transparency = 0}
    ...
    -- ESP Fonts
    ESPFonts = {
        ["ProggyClean"] = Font.new("rbxasset://fonts/families/ProggyClean.json"),
        ["Tahoma"] = Font.new("rbxasset://fonts/families/LegacyArial.json"),
        ["Verdana"] = Font.new("rbxasset://fonts/families/Verdana.json"),
        ["SmallestPixel"] = Font.new("rbxasset://fonts/families/Arial.json"),
        ["ProggyTiny"] = Font.new("rbxasset://fonts/families/ProggyClean.json"),
        ["Minecraftia"] = Font.new("rbxasset://fonts/families/Arial.json"),
        ["Tahoma Bold"] = Font.new("rbxasset://fonts/families/ArialBold.json")
    }
